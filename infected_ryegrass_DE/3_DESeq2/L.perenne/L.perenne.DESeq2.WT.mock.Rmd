...
pdf("plots/WT_vs_mock_top_DE_genes.pdf" )
...
```{r plot_dispersions}
pdf("plots/WT_vs_mock_plot_dispersions.pdf", onefile = FALSE)
plotDispEsts(dds)
dev.off()
```
...
pdf("plots/WT_vs_mock_apeglm_shrinkage_MA_plot.pdf", onefile = FALSE)
...
pdf("plots/WT_vs_mock_volcano_plot.pdf", onefile = FALSE)
...
write.table(goi, "result_tables/L.perenne_WT_mock.txt", quote = FALSE, row.names = FALSE, sep = "\t")
```
...
write.table(goi, "result_tables/L.perenne_WT_mock_annotated.txt", quote = FALSE, row.names = FALSE, sep = "\t")
```
