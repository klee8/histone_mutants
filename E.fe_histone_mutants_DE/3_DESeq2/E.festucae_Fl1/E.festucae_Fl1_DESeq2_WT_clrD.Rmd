---
title: "E.festucae_Fl1_clrD_vs_wt"
...
write.table(goi, "result_tables/E.festucae_Fl1_WT_clrD.txt", quote = FALSE, row.names = FALSE, sep = "\t")
```
...
```{r merge_normalised_DESeq2_count_data, include=FALSE}
